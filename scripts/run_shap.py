...
def parse_args():
    ...
    p.add_argument("--model_type", required=True, choices=["logreg", "multi_task", "single_task"], help="Type of model checkpoint")
...
def main():
    ...
    if args.model_type == "logreg":
        ...
        run_shap_multi_task_transformer(
            ...
            text_col="text",
            model_path=args.ckpt,
            task_name=args.task,   # <-- use the actual task string
...
python -m scripts.run_shap \
  ...
  --task Q2_harmful \
  --out_csv results/explainability/shap/shap_q2_harmful.csv
